...
const BUGS = [
  { id: 'BUG-CALC-001', build: 1, severity: 'Major', foundBy: ['TC-VAL-001', 'TC-VAL-002'], symptom: 'Bỏ check số: Abc+9 ra NaN, không báo lỗi' },
  { id: 'BUG-CALC-002', build: 2, severity: 'Critical', foundBy: ['TC-ADD-001', 'TC-CON-001', 'TC-CON-002'], symptom: 'Đảo Add↔Concat: 10+9 ra 109' },
  { id: 'BUG-CALC-003', build: 3, severity: 'Major', foundBy: ['TC-CON-001'], symptom: 'Luôn coi là số: Concat ab+cd báo not a number' },
  { id: 'BUG-CALC-004', build: 4, severity: 'Major', foundBy: ['TC-DIV-001', 'TC-INT-001'], symptom: 'Khóa integer: checkbox disabled' },
  { id: 'BUG-CALC-005', build: 5, severity: 'Minor', foundBy: ['TC-CLEAR-001'], symptom: 'Nút Clear disabled ngay sau chọn build' },
  { id: 'BUG-CALC-006', build: 6, severity: 'Major', foundBy: ['TC-DIV-002'], symptom: 'Không check chia 0: 10/0 ra Infinity' },
